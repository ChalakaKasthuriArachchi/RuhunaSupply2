...
namespace RuhunaSupply.Controllers
{
    public class SupplierController : ControllerBase
    {
        ...
        public IActionResult Add(string RegisterNumber, Category2 Category2, DateTime RegisterDate, string TelephoneNumber,  string BusinessName,  string BusinessMail, string BusinessAddress)
        {
            int max_id = 0;
            try
            {
